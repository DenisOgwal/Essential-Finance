...
namespace Banking_System
{
    ...
    class PrintDGV
    {
        ...
        static string companyemail = null;
        static string companyaddress = null;
        static string companycontact = null;
        static string companyslogan = null;
                    ...
                    System.Drawing.Printing.PrintPageEventArgs e) 
        {
	        ...
	        {	        
                ...
                while (RowPos <= dgv.Rows.Count - 1)
                {
                    ...
                    else
                    {
                        if (NewPage)
                        {
                            ...
                            // Draw Header
                            e.Graphics.DrawString(companyname, new Font(drawFontArial12Bold, FontStyle.Bold),Brushes.Black, new RectangleF(x, y, e.PageBounds.Width, e.PageBounds.Height), drawFormatCenter);
                            y += e.Graphics.MeasureString(companyname, drawFontArial12Bold).Height;
                            e.Graphics.DrawString(companyemail, new Font(drawFontArial10Bold, FontStyle.Bold), Brushes.Black, new RectangleF(x, y, e.PageBounds.Width, e.PageBounds.Height), drawFormatCenter);
                            y += e.Graphics.MeasureString(companyemail, drawFontArial12Bold).Height;
                            e.Graphics.DrawString(companycontact, new Font(dgv.Font, FontStyle.Bold), Brushes.Black, new RectangleF(x, y, e.PageBounds.Width, e.PageBounds.Height), drawFormatCenter);
                            y += e.Graphics.MeasureString(companycontact, drawFontArial12Bold).Height;

                          

                            e.Graphics.DrawString(PrintTitle, new Font(dgv.Font, FontStyle.Bold), Brushes.Black, new RectangleF(x, y, e.PageBounds.Width, e.PageBounds.Height), drawFormatCenter);
                            y += e.Graphics.MeasureString(PrintTitle, drawFontArial12Bold).Height;
                ...
                String s = "Date: " + DateTime.Now.ToLongDateString() + " " + DateTime.Now.ToShortTimeString();

                //e.Graphics.DrawString(s, new Font(dgv.Font, FontStyle.Bold), Brushes.Black, new RectangleF(x, y, e.PageBounds.Width, e.PageBounds.Height), drawFormatCenter);
                StringFormat drawFormatLefts = new StringFormat();
                drawFormatLefts.Alignment = StringAlignment.Near;
                e.Graphics.DrawString(s, dgv.Font, Brushes.Black,
               e.MarginBounds.Left + (e.MarginBounds.Width -
               e.Graphics.MeasureString(s, dgv.Font,
               e.MarginBounds.Width).Width), e.MarginBounds.Top +
               e.MarginBounds.Height + 31,drawFormatLefts);
            }
	        catch (Exception ex)
	        {
                MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);        		
