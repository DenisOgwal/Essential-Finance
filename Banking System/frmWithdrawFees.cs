...
{
    public partial class frmWithdrawFees : DevComponents.DotNetBar.Office2007Form
    {
        ...
        private void buttonX2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                string cb = "insert into WithdrawFees(Months,Year,SettingDate,WithdrawFee,ChairPerson,WithdrawFeeMIN,WithdrawFeeMAX) VALUES (@d1,@d2,@d3,@d4,@d5,@d6,@d7)";
                ...
                cmd.Parameters.Add(new SqlParameter("@d4", System.Data.SqlDbType.Int, 20, "WithdrawFee"));
                cmd.Parameters.Add(new SqlParameter("@d5", System.Data.SqlDbType.NChar, 40, "ChairPerson"));
                cmd.Parameters.Add(new SqlParameter("@d6", System.Data.SqlDbType.Int, 20, "WithdrawFeeMIN"));
                cmd.Parameters.Add(new SqlParameter("@d7", System.Data.SqlDbType.Int, 20, "WithdrawFeeMAX"));
        ...
        private void buttonX3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cq = "delete  from  WithdrawFees where Months=@DELETE1 and Year=@delete2 and SettingDate=@date3;";
        ...
        private void buttonX4_Click(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cb = "update WithdrawFees set WithdrawFee=@d4,WithdrawFeeMIN=@d6,WithdrawFeeMAX=@d7 where Year=@d2 and Months=@d1 and SettingDate=@d3";
                cmd = new SqlCommand(cb);
                cmd.Connection = con;
                cmd.Parameters.Add(new SqlParameter("@d1", System.Data.SqlDbType.NChar, 10, "Months"));
                cmd.Parameters.Add(new SqlParameter("@d2", System.Data.SqlDbType.NChar, 10, "Year"));
