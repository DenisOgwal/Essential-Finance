...
{
    public partial class FrmLoanProcessingApproval : DevComponents.DotNetBar.Office2007RibbonForm
    {
        ...
        public FrmLoanProcessingApproval()
        {
            InitializeComponent();
        }
        ...
        private void FrmLoanFirstApproval_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("select RTRIM(AccountNo)[Account No.],RTRIM(AccountName)[Account Name],RTRIM(LoanID)[Loan ID] from Loan where ProcessingApproval='Pending' order by ID DESC", con);
        ...
        private void ApprovalID_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (rdr.Read())
                {
                    ...
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    string ct = "SELECT UserName,StaffID FROM ApprovalRights WHERE StaffID='" + staffids + "' and LoanProcessing='Yes'";
           ...
           /* con = new SqlConnection(cs.DBConn);
            ...
            try
            {
                if (approvals.Text == "Approved")
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    string cb = "UPDATE Loan SET ProcessingApprovalDate=@d4,ProcessingApproval=@d5,FirstApproval='Pending',ProcessingApprovalComment=@d6,ProcessingApprovedBy=@d7,LoanAmount='" + Amount.Value + "',Intervals='" + PaymentInterval.Value + "' WHERE LoanID=@d1";
                    ...
                    cmd.Parameters.Add(new SqlParameter("@d4", System.Data.SqlDbType.NChar, 20, "ProcessingApprovalDate"));
                    cmd.Parameters.Add(new SqlParameter("@d5", System.Data.SqlDbType.NChar, 20, "ProcessingApproval"));
                    cmd.Parameters.Add(new SqlParameter("@d6", System.Data.SqlDbType.Text, 500, "ProcessingApprovalComment"));
                    cmd.Parameters.Add(new SqlParameter("@d7", System.Data.SqlDbType.NChar, 50, "ProcessingApprovedBy"));
                ...
                else
                {
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    string cb = "UPDATE Loan SET ProcessingApprovalDate=@d4,ProcessingApproval=@d5,FirstApproval='Rejected',FinalApproval='Rejected',ProcessingApprovalComment=@d6,ProcessingApprovedBy=@d7,LoanAmount='" + Amount.Value + "',Intervals='" + PaymentInterval.Value + "' WHERE LoanID=@d1";
                    cmd = new SqlCommand(cb);
                    cmd.Connection = con;
                    cmd.Parameters.Add(new SqlParameter("@d1", System.Data.SqlDbType.NChar, 20, "LoanID"));
                    cmd.Parameters.Add(new SqlParameter("@d2", System.Data.SqlDbType.NChar, 20, "AccountNo"));
