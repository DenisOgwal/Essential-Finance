...
{
    public partial class frmSavingsInterest : DevComponents.DotNetBar.Office2007Form
    {
        ...
        private void frmSavingsInterest_Load(object sender, EventArgs e)
        {
        ...
        private void buttonX2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                string cb = "insert into DepositInterest(Months,Year,IntrestDate,InterestRate,ChairPersonName) VALUES (@d1,@d2,@d3,@d4,@d5)";
                ...
                cmd.Parameters.Add(new SqlParameter("@d3", System.Data.SqlDbType.NChar, 20, "IntrestDate"));
                cmd.Parameters.Add(new SqlParameter("@d4", System.Data.SqlDbType.Float, 20, "InterestRate"));
                cmd.Parameters.Add(new SqlParameter("@d5", System.Data.SqlDbType.NChar, 50, "ChairPersonName"));
        ...
        private void buttonX3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cq = "delete * from  DepositInterest where Months=@DELETE1 and Year=@delete2 and IntrestDate=@date3;";
                ...
                cmd.Parameters.Add(new SqlParameter("@delete3", System.Data.SqlDbType.NChar, 15, "IntrestDate"));
        ...
        private void buttonX4_Click(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cb = "update DepositInierest set InterestRate=@d4 where Year=@d2 and Months=@d1 and IntrestDate=@d3";
                cmd = new SqlCommand(cb);
                cmd.Connection = con;
                cmd.Parameters.Add(new SqlParameter("@d1", System.Data.SqlDbType.NChar, 10, "Months"));
                cmd.Parameters.Add(new SqlParameter("@d2", System.Data.SqlDbType.NChar, 10, "Year"));
