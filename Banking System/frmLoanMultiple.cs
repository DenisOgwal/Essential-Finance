...
{
    public partial class frmLoanMultiple : DevComponents.DotNetBar.Office2007Form
    {
        ...
        private void buttonX2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please enter Multiple", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                interestrate.Focus();
                return;
            }
            try
            {
                ...
                con.Open();
                string cb = "insert into LoanMultiple(Months,Year,MultipleDate,Multiple,ChairPerson) VALUES (@d1,@d2,@d3,@d4,@d5)";
                ...
                cmd.Parameters.Add(new SqlParameter("@d4", System.Data.SqlDbType.Float, 20, "Multiple"));
        ...
        private void buttonX3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cq = "delete * from  LoanMultiple where Months=@DELETE1 and Year=@delete2 and MultipleDate=@date3;";
        ...
        private void buttonX4_Click(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cb = "update LoanMultiple set Multiple=@d4 where Year=@d2 and Months=@d1 and MultipleDate=@d3";
                cmd = new SqlCommand(cb);
                cmd.Connection = con;
                cmd.Parameters.Add(new SqlParameter("@d1", System.Data.SqlDbType.NChar, 10, "Months"));
                cmd.Parameters.Add(new SqlParameter("@d2", System.Data.SqlDbType.NChar, 10, "Year"));
                cmd.Parameters.Add(new SqlParameter("@d3", System.Data.SqlDbType.NChar, 20, "MultipleDate"));
                cmd.Parameters.Add(new SqlParameter("@d4", System.Data.SqlDbType.Int, 20, "Multiple"));
