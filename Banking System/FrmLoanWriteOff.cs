...
{
    public partial class FrmLoanWriteOff : DevComponents.DotNetBar.Office2007RibbonForm
    {
        ...
        private void buttonX2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cb = "insert into WriteOff(LoanID,AccountNumber,AccountNames,Reason,RequestDate,RequestedBy) VALUES (@d1,@d2,@d3,@d4,@d5,@d6)";
                ...
                cmd.Parameters.Add(new SqlParameter("@d4", System.Data.SqlDbType.NChar, 500, "Reason"));
                cmd.Parameters.Add(new SqlParameter("@d5", System.Data.SqlDbType.NChar, 20, "RequestDate"));
                cmd.Parameters.Add(new SqlParameter("@d6", System.Data.SqlDbType.NChar, 40, "RequestedBy"));
                cmd.Parameters["@d1"].Value = LoanID.Text;
                cmd.Parameters["@d2"].Value = AccountNumber.Text;
                cmd.Parameters["@d3"].Value = AccountName.Text;
                cmd.Parameters["@d4"].Value = Reason.Text;
                cmd.Parameters["@d5"].Value = ApplicationDate.Text;
                cmd.Parameters["@d6"].Value = ApprovalName.Text;
                cmd.ExecuteNonQuery();
                con.Close();
