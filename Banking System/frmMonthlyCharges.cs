...
{
    public partial class frmMonthlyCharge : DevComponents.DotNetBar.Office2007Form
    {
        ...
        private void buttonX2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                string cb = "insert into MonthlyFee(Months,Year,MultipleDate,MonthlyFee,ChairPerson) VALUES (@d1,@d2,@d3,@d4,@d5)";
