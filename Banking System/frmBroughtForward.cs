...
{
    public partial class frmBroughtForward : DevComponents.DotNetBar.Office2007Form
    {
        ...
        private void auto()
        {
            ...
            txtPaymentID.Text = "BF-" + years + monthss + days + GetUniqueKey(5);
        }
        ...
        private void buttonX3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                string cb = "insert into BroughtForward(TransactionID,Year,Months,Date,Ammount,TransactionType,TransactionDetails,AuthorisedBy) VALUES (@d1,@d2,@d3,@d4,@d5,@d6,@d7,@d8)";
                ...
                cmd.Parameters.Add(new SqlParameter("@d6", System.Data.SqlDbType.NChar, 20, "TransactionType"));
                cmd.Parameters.Add(new SqlParameter("@d7", System.Data.SqlDbType.NChar, 100, "TransactionDetails"));
                cmd.Parameters.Add(new SqlParameter("@d8", System.Data.SqlDbType.NChar, 40, "AuthorisedBy"));
                ...
                cmd.Parameters["@d5"].Value = Convert.ToInt32(txtTotalPaid.Value);
        ...
        private void delete_records()
        {
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cq = "delete  from BroughtForward where TransactionID=@DELETE1;";
        ...
        private void buttonX5_Click(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cb = "update BroughtForward set Date=@d4,Months=@d3,Year=@d2,AuthorisedBy=@d8,Ammount=@d5 where TransactionID=@d1";
                cmd = new SqlCommand(cb);
                cmd.Connection = con;
                cmd.Parameters.Add(new SqlParameter("@d1", System.Data.SqlDbType.NChar, 15, "TransactionID"));
                cmd.Parameters.Add(new SqlParameter("@d2", System.Data.SqlDbType.NChar, 10, "Year"));
        ...
        private void frmBroughtForward_Load(object sender, EventArgs e)
        {
