...
{
    public partial class frmProperty : DevComponents.DotNetBar.Office2007RibbonForm
    {
        ...
        private void delete_records()
        {
            try
            {
                ...
                con.Open();
                string cq = "delete from Property where PropertyID=@DELETE1;";
        ...
        private void buttonX2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string ct = "select product from Property where Product= '" + product.Text + "' and Price= '" + Price.Text + "'";
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cb = "insert into Property(PropertyID,product,units,PriceDate,description,Price) VALUES (@d1,@d2,@d5,@d6,@d7,@d8)";
        ...
        private void buttonX4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cb = "update Property set Price=@d8, product=@d2,units=@d5,description=@d7,PriceDate=@d6 where PropertyID=@d1";
                cmd = new SqlCommand(cb);
                cmd.Connection = con;
                cmd.Parameters.Add(new SqlParameter("@d1", System.Data.SqlDbType.NChar, 15, "PropertyID"));
                cmd.Parameters.Add(new SqlParameter("@d2", System.Data.SqlDbType.NChar, 50, "product"));
