...
{
    public partial class frmDrawings : DevComponents.DotNetBar.Office2007Form
    {
        ...
        private void auto()
        {
            txtPaymentID.Text = "GID-" + GetUniqueKey(8);
        }
        ...
        private void buttonX3_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please enter Ammount withdrawn", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtTotalPaid.Focus();
                return;
            }
            ...
            try
            {
                ...
                con.Open();
                string cb = "insert into Drawings (TransactionID,Year,Months,Date,Ammount,AuthorisedBy,TransactionDetails,TransactionType) VALUES (@d1,@d2,@d3,@d4,@d5,@d6,@d7,@d8)";
                ...
                cmd.Parameters.Add(new SqlParameter("@d3", System.Data.SqlDbType.NChar, 30, "Months"));
                cmd.Parameters.Add(new SqlParameter("@d4", System.Data.SqlDbType.NChar, 20, "Date"));
                cmd.Parameters.Add(new SqlParameter("@d5", System.Data.SqlDbType.Int, 20, "Ammount"));
                cmd.Parameters.Add(new SqlParameter("@d6", System.Data.SqlDbType.NChar, 50, "AuthorisedBy"));
                cmd.Parameters.Add(new SqlParameter("@d7", System.Data.SqlDbType.NChar, 40, "TransactionDetails"));
                cmd.Parameters.Add(new SqlParameter("@d8", System.Data.SqlDbType.NChar, 20, "TransactionType"));
                cmd.Parameters["@d1"].Value = txtPaymentID.Text;
                cmd.Parameters["@d2"].Value = Year.Text; 
                cmd.Parameters["@d3"].Value = months.Text;
                cmd.Parameters["@d4"].Value = dtpPaymentDate.Text; 
                cmd.Parameters["@d5"].Value = Convert.ToInt32(txtTotalPaid.Text); 
                cmd.Parameters["@d6"].Value =staffname.Text;
                cmd.Parameters["@d7"].Value = txtPaymentModeDetails.Text;
                cmd.Parameters["@d8"].Value = cmbModeOfPayment.Text;
                cmd.ExecuteReader();
                con.Close();
                SqlDataReader rdr = null;
                int totalaamount = 0;
                ...
                if (rdr.Read())
                {
                    ...
                    int newtotalammount = totalaamount - Convert.ToInt32(txtTotalPaid.Text);
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
        ...
        private void delete_records()
        {
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cq = "delete * from Drawings where TransactionID=@DELETE1;";
        ...
        private void buttonX5_Click(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cb = "update Drawings set TransactionDetails=@d8,Date=@d5,Months=@d4,Year=@d3,AuthorisedBy=@d7,Ammount=@d6 where PaymentID=@d1";
                cmd = new SqlCommand(cb);
                cmd.Connection = con;
                cmd.Parameters.Add(new SqlParameter("@d1", System.Data.SqlDbType.NChar, 15, "TransactionID"));
                ...
                cmd.Parameters.Add(new SqlParameter("@d6", System.Data.SqlDbType.Int, 20, "Ammount"));
                cmd.Parameters.Add(new SqlParameter("@d7", System.Data.SqlDbType.NChar, 50, "AuthorisedBy"));
                cmd.Parameters.Add(new SqlParameter("@d8", System.Data.SqlDbType.NChar, 100, "TransactionDetails"));
                cmd.Parameters["@d1"].Value = txtPaymentID.Text;
        ...
        private void staffid_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (rdr.Read())
                {
                    ...
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    string ct = "SELECT UserName,StaffID FROM ApprovalRights WHERE StaffID='" + staffids + "' and Dividends='Yes'";
