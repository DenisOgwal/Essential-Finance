    ...
    public partial class frmChangePassword : DevComponents.DotNetBar.Office2007Form
    {
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                EncryptText(txtNewPassword.Text, "essentialfinance");
                EncryptText2(txtOldPassword.Text, "essentialfinance");
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string co = "Update User_Registration set Password = '" + result + "'where UserName='" + txtUserName.Text + "' and Password = '" + result2 + "'";
