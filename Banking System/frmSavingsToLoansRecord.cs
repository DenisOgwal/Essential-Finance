...
{
    public partial class frmSavingsToLoansRecord : DevComponents.DotNetBar.Office2007Form
    {
        ...
        public frmSavingsToLoansRecord()
        {
            InitializeComponent();
        }
        ...
        private void cmbStaffName_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                DGV.DataSource = myDataSet.Tables["SavingsToLoans"].DefaultView;
                con.Close();
            }
            catch (Exception ex)
            {
        ...
        private void buttonX3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet myDataSet = new DataSet();
                myDA.Fill(myDataSet, "SavingsToLoans");
                dataGridView1.DataSource = myDataSet.Tables["SavingsToLoans"].DefaultView;
                con.Close();
            }
            catch (Exception ex)
            {
