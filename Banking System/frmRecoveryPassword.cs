...
{
    public partial class frmRecoveryPassword : DevComponents.DotNetBar.Office2007Form
    {
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    DecryptText(Convert.ToString(ds.Tables[0].Rows[0]["Password"]), "essentialfinance");
                    Msg.Subject = "Your Password Details";
                    Msg.Body = "Your Password is: " +results + " and your Username is:" + Convert.ToString(ds.Tables[0].Rows[0]["Username"]);
                    Msg.IsBodyHtml = true;
