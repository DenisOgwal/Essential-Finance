...
{
    public partial class frmDevidendsRecord : DevComponents.DotNetBar.Office2007Form
    {
        ...
        private void AutocompleteStaffName()
        {
            try
            {
                ...
                adp.SelectCommand = new SqlCommand("SELECT distinct RTRIM(AuthorisedBy) FROM Drawings", CN);
                ds = new DataSet("ds");
                adp.Fill(ds);
                dtable = ds.Tables[0];
